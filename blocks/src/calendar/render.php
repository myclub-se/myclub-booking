...
$myclub_booking_header = get_option( 'myclub_booking_calendar_title' );

?>
    <div class="myclub-booking-calendar">
        <div class="myclub-booking-calendar-container">
            <h3 class="myclub-booking-header"><?php echo esc_attr( $myclub_booking_header ) ?></h3>
<?php
    $myclub_booking_bookable_id = $attributes['bookable_id'] ?? '';
    $myclub_booking_calendar_labels = [
        ...
        <div id="calendar-div"
             data-labels="<?php echo esc_attr( wp_json_encode( $myclub_booking_calendar_labels, JSON_UNESCAPED_UNICODE ) ); ?>"
             data-locale="<?php echo esc_attr( get_locale() ); ?>"
             data-bookable-id="<?php echo esc_attr( $myclub_booking_bookable_id ); ?>"
