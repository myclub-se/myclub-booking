...
namespace MyClub\MyClubBooking\BackgroundProcessing;
...
abstract class Background_Process extends Async_Request {
	...
	public function schedule_cron_healthcheck( $schedules ) {
		...
		$schedules[ $this->cron_interval_identifier ] = array(
			...
			'display'  => 1 === $interval ? esc_html__( 'Every Minute', 'myclub-booking' ) : sprintf( esc_html__( 'Every %d Minutes', 'myclub-booking' ), $interval ),
		);
